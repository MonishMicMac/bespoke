                    ...
                    <li class="list-inline-item">
                        <div class="menubar">
                            <a class="menu-hamburger" href="javascript:void();">
                               ...
                               <img src="{{ asset('assets/images/svg-icon/dashboard.svg') }}" class="img-fluid menu-hamburger-collapse" alt="collapse">
                               <img src="{{ asset('assets/images/svg-icon/dashboard.svg') }}"  class="img-fluid menu-hamburger-close" alt="close">
                             </a>
                         </div>
                    </li>
                    <li class="list-inline-item">
